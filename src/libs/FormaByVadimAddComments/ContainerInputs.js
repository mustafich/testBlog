...
import {PostMessageAdd} from  "./../../redux/actions/PostMessageAdd"
...
class ContainerInputs extends React.Component {
    ...
    async buttonSend() {
        ...
        if (arrArguments.every((e) => {
            ...
            PostMessageAdd("https://simpleblogapi.herokuapp.com/comments", {
                body: this.state.form.body,
                postId: parseInt(this.props.url.match(/\d+/)),
